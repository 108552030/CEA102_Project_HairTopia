...
//		        out.println("</BODY></HTML>");
				...
				res.sendRedirect(req.getContextPath() + "/frontEnd/member/login_success.jsp");
			}
		}
		// forget password
...
//				ms.sendMail(account, subject, messageText);
				...
				RequestDispatcher SuccessView = req.getRequestDispatcher("/frontEnd/member/email_send_success.jsp");
				SuccessView.forward(req, res);
				return;
			} else {
				errorMsgs.add("信箱不存在");
				RequestDispatcher failureView = req.getRequestDispatcher("/frontEnd/member/forgetPassword.jsp");
				failureView.forward(req, res);
				return;
			}
//			memSvc.get
