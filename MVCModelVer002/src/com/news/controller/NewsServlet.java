...
//	            }
				...
				if (newsCon == null || newsCon.trim().length() == 0) {
				...
				/***************************2.開始修改資料*****************************************/
				NewsService newsSvc = new NewsService();
				newsVO = newsSvc.updateNews(newsNo, newsTitle, newsCon);
				
				/***************************3.修改完成,準備轉交(Send the Success view)*************/				
//				NewsService deptSvc = new NewsService();
//				if(requestURL.equals("/news/listEmps_ByDeptno.jsp") || requestURL.equals("/news/listAllDept.jsp"))
