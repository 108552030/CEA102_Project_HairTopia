...
<html>
<head>
<title>News Test select page</title>
...
<ul>
  <li><a href='<%=request.getContextPath()%>/front-end/member/listAllMember.jsp'>List</a> all Emps.  <br><br></li>
...
<ul>
  <li><a href='<%=request.getContextPath()%>/front-end/member/addMember.jsp'>Add</a> a new Emp.</li>
</ul>
