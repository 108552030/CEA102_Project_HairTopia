...
<html>
<head>
<title>所有條款資料 - listAllRule.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>所有條款資料 - listAllRule.jsp</h3>
		 <h4><a href="<%=request.getContextPath()%>/back-end/rule/select_rule_page.jsp"><img src="<%=request.getContextPath()%>/resource/images/back1.gif" width="100" height="32" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	...
	<c:forEach var="ruleVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
